...
- `Local URL` - Add the local URL to your Overseerr if you want direct links for movies and shows
...
4. Add the notification URL `https://notifiarr.com/api/v1/notification/overseerr/api_key_here` - Make sure to make an API key specific to Overseerr
